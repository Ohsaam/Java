...
public class CallbyValueTest2 {
	...
	void effectParam(Param1 p1) {//p = null;  -> p = new Param()  /// p-> null로 반환 +nullpointException
		//insert here - 여기에 p = new Param()을 추가한다면
		//결과는 어떻게 달라질까요? 아님 변화가 없는 건가요?
		p1 = new Param1();
		p1.ival = 100;
		System.out.println("sub ival ==> " + p1.ival);		
	}
	public static void main(String[] args) {
		...
		p.ival = 500;
		//p = null;
		CallbyValueTest2 tp = new CallbyValueTest2();//인스턴스화 라고 한다. - heap메모리에 자리함
		//insert here
		tp.effectParam(p);
