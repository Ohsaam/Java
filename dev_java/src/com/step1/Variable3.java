...
public class Variable3{
	...
	//사용자 즉 개발자가 임의의 메소드를 얼마든지 선언할 수 있고 구현할 수 있어요
	public void account(int i, int j) {//파라미터 자리에 선언된 변수는 지역변수이다 - 값이 결정되지 않았다. - 그럼 언제 결정되나요? - 27번라인에서 초기화됨
		System.out.println("account호출 성공");
		System.out.println(i);//1
		System.out.println(j);//2 - call by value
	}
	//컴파일을 하는 언어는 컴파일 타임에 문법체크 함
