...
public class JFrameTest1 extends JFrame {
	//파라미터가 한개도 없으니까 JVM이 대신 만들어줄수 있다.
	...
	public void initDisplay() {
		...
		//내(JFrameTest1) 안에 선언된 메소드(setSize(int, int)가 아니다. 그럼 어디에??? - JFrame있다.
		//this는 자바가 제공하는 수정자 이고 보통 자기자신을 가리킬 때 사용함
		//주로 전변과 지변의 이름이 같은 경우 구분하기 위해 개발자 명시적으로 붙여줌- 생략하지 않음
	...
	public static void main(String[] args) {
		//main 내부에서  인스턴스화를 하면 지변의 성격을 갖는다.
		...
		//메소드 파라미터 자리가 원시형 타입인 경우 + 갯수 판단하고 결정 처리
