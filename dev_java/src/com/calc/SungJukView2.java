...
//
//public class SungJukView2 implements ActionListener {
//	
...
//	JTextField jt_avg = new JTextField(6);
//	JTextField jt_total  = new JTextField(6);
//	JTextField jt_list  = new JTextField(6);
//	JTextField jt_grade  = new JTextField(6);
//	
//	
...
//	if(obj==jbt_process)
//	{
////	    System.out.println("jbt_process 버튼이 클릭되었습니다."); // 디버깅 메시지 추가
////	    calc.setStudents(score);
////	    calc.averageScoreMethod();
////	    System.out.println("averageScoreMethod() 호출됨"); // 메서드 호출 확인용 메시지
////	    calc.totalScoreMethod();
////	    System.out.println("totalScoreMethod() 호출됨"); // 메서드 호출 확인용 메시지
////	    calc.GradeScoreMethod();
////	    System.out.println("GradeScoreMethod() 호출됨"); // 메서드 호출 확인용 메시지
////	    calc.RankMethod();
////	    System.out.println("RankMethod() 호출됨"); // 메서드 호출 확인용 메시지
//
//	//score.
//		
//
